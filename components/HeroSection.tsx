...
export default function HeroSection() {
  ...
  return (
    <section className="relative -mt-24 min-h-[760px] pt-40 pb-20 overflow-hidden bg-gradient-to-br from-[#0B120E] via-[#27382B] to-[#0B120E] text-white flex items-center">
      ...
      {/* Hero Main Content */}
      <div className="max-w-full mx-auto px-4 sm:px-8 relative z-20 w-full">
        <div className="max-w-[760px] space-y-6">

          {/* Static H1 Title */}
          <h1 className=" text-4xl font-medium sm:text-6xl lg:text-[60px] leading-[1.08] text-white tracking-tight drop-shadow-lg">
            {titleText}
          </h1>

          {/* Subtitle (static) */}
          <p className="font-normal text-base sm:text-lg text-[#C6CCC1] max-w-[560px] leading-relaxed pt-1 drop-shadow">
            {subtitleText}
          </p>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-4">
            ...
            <Link
              href="/capabilities"
              className="px-8 py-3.5 font-semibold text-sm sm:text-base text-white bg-[#2E4B30] hover:bg-[#a6d278] transition-all shadow-lg hover:shadow-[#95c168]/30 font-bold"
            >
              Capabilities
            </Link>
